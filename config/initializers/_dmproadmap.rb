...
module DMPRoadmap
  ...
  class Application < Rails::Application
    ...
    config.x.organisation.name = "Digital Curation Centre"
    ...
    config.x.organisation.email = "dmponline@dcc.ac.uk"
    # This email is used as the 'from' address for the feedback_complete email to users
    config.x.organisation.do_not_reply_email "do-not-reply@dcc.ac.uk"
    # This email is used in email communications
    config.x.organisation.helpdesk_email = "dmponline@dcc.ac.uk"
