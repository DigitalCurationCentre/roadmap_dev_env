...
module DMPRoadmap
  ...
  class Application < Rails::Application
    ...
    config.x.organisation.name = "DataHub Maastricht"
    # Your organisation's abbreviation
    config.x.organisation.abbreviation = "DCC & UC3"
    # Your organisation's homepage, used in some of the public facing pages
    config.x.organisation.url = "https://datahub.mumc.maastrichtuniversity.nl/"
    ...
    config.x.organisation.email = "datahub@maastrichtuniversity.nl"
    # This email is used as the 'from' address for the feedback_complete email to users
    config.x.organisation.do_not_reply_email "do-not-reply@maastrichtuniversity.nl"
    # This email is used in email communications
    config.x.organisation.helpdesk_email = "datahub@maastrichtuniversity.nl"
...
#    config.x.organisation.google_maps_link = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2234.161155755649!2d-3.20321924802974!3d55.9465786805105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4887c7991ae08cb3%3A0xc79a722a444e2bd9!2sArgyle+House!5e0!3m2!1sen!2suk!4v1498229761452"
    ...
    config.x.application.name = "DMPMaastricht"
    ...
    config.x.application.archived_accounts_email_suffix = "@dmpmaastrict-removed.user"
